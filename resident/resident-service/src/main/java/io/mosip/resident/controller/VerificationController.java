...
public class VerificationController {
    ...
    public ResponseWrapper<?> getChannelVerificationStatus(@PathVariable("channel") String channel,
        ...
        ResponseWrapper<?> responseWrapper = verificationServiceImpl.checkChannelVerificationStatus(channel, individualId);
