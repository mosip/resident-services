...
public class ResidentVidController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "VID Policy retrieved successfully",
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Forbidden" ,content = @Content(schema = @Schema(hidden = true))),
            @ApiResponse(responseCode = "404", description = "Not Found" ,content = @Content(schema = @Schema(hidden = true)))})
    public ResponseEntity<Object> generateVidWithoutOTP(@RequestBody(required = true) ResidentVidRequestDto requestDto) throws ResidentServiceCheckedException, OtpValidationFailedException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "Unauthorized" ,content = @Content(schema = @Schema(hidden = true))),
            @ApiResponse(responseCode = "403", description = "Forbidden" ,content = @Content(schema = @Schema(hidden = true)))})
    public ResponseEntity<Object> revokeVidWithoutOTP(@RequestBody(required = true) RequestWrapper<VidRevokeRequestDTO> requestDto, @PathVariable String vid) throws OtpValidationFailedException, ResidentServiceCheckedException {
    	requestDto.getRequest().setOtp(null); 
    	return revokeVid(requestDto, vid, false);
    }

	private ResponseEntity<Object> revokeVid(RequestWrapper<VidRevokeRequestDTO> requestDto, String vid, boolean isOtpValidationRequired)
			throws OtpValidationFailedException, ResidentServiceCheckedException {
