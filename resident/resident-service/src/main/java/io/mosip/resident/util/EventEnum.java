...
public enum EventEnum {
	...
	RID_STATUS_RESPONSE("RES-SER-111", RegistrationConstants.SYSTEM, "RID status response", "RID status is %s",
			"RES-SER", "Residence service", "RS-RID", "RID Status", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_EUIN("RES-SER-102", RegistrationConstants.SYSTEM, "Request EUIN", "Requesting euin for transaction id %s",
			"RES-SER", "Residence service", "RS-UIN", "UIN", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_EUIN_SUCCESS("RES-SER-210", RegistrationConstants.SYSTEM, "Request EUIN: Success",
			"Requesting euin for transaction id %s is success", "RES-SER", "Residence service", "RS-UIN", "UIN",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	REQ_PRINTUIN("RES-SER-103", RegistrationConstants.SYSTEM, "Request print UIN",
	...
	UPDATE_UIN("RES-SER-107", RegistrationConstants.SYSTEM, "Request update uin",
			"Requesting update uin  api for transaction id %s", "RES-SER", "Residence service", "RS-UIN", "UIN",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	VALIDATE_OTP("RES-SER-113", RegistrationConstants.SYSTEM, "validate otp", "Validate OTP for %s", "RES-SER",
	...
	GETTING_RID_STATUS("RES-SER-116", RegistrationConstants.SYSTEM, "Checking RID status",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	SEND_NOTIFICATION_FAILURE("RES-SER-403", RegistrationConstants.SYSTEM, "Send notification: Failure",
	...
	VID_ALREADY_EXISTS("RES-SER-405", RegistrationConstants.SYSTEM, "VID already exists",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	VID_GENERATION_FAILURE("RES-SER-406", RegistrationConstants.SYSTEM, "Request to generate VID: Failure",
	...
	RID_NOT_FOUND("RES-SER-408", RegistrationConstants.SYSTEM, "Checking RID status: Not found",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	TOKEN_GENERATION_FAILED("RES-SER-409", RegistrationConstants.SYSTEM, "Generating token: Failure", "Token generation failed",
	...
	JSON_PARSING_EXCEPTION("RES-SER-421", RegistrationConstants.SYSTEM, "Request for UIN update: Exception",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	OTP_VALIDATION_FAILED("RES-SER-422", RegistrationConstants.SYSTEM, "OTP validation: Failure",
	...
	PACKET_CREATED("RES-SER-119", RegistrationConstants.SYSTEM, "Request to upload UIN packet", "Uploading UIN packet",
			"RES-SER", "Residence service", "RS-PACK", "Packet creation", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	PACKET_CREATED_FAILURE("RES-SER-425", RegistrationConstants.SYSTEM, "Request to upload UIN packet: Failure",
	...
	CREDENTIAL_TYPES("RES-SER-133", RegistrationConstants.SYSTEM, "credential types", "credential types", "RES-SER",
			"Residence service", "RS-CRED_TYP", "Credential type", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_VALID_DOCUMENT("RES-SER-143", RegistrationConstants.SYSTEM, "get valid documents",
			"get valid documents by lang code", "RES-SER", "Residence service", "RS-DOC", "Document",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_LOCATION_HIERARCHY_LEVEL("RES-SER-146", RegistrationConstants.SYSTEM, "get location hierarchy levels",
			"get location hierarchy level by lang code", "RES-SER", "Residence service", "RS-LOC", "Location",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_LOCATION_HIERARCHY_LEVEL_EXCEPTION("RES-SER-148", RegistrationConstants.SYSTEM, "get location hierarchy levels: Failure",
	...
	GET_COORDINATE_SPECIFIC_REG_CENTERS_EXCEPTION("RES-SER-157", RegistrationConstants.SYSTEM,
			"get coordinate specific registration centers", "get coordinate specific registration centers: Failure",
			"RES-SER", "Residence service", "RS-REG", "Registration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTERS_FOR_LOCATION_CODE("RES-SER-161", RegistrationConstants.SYSTEM,
			...
			"Residence service", "RS-REG_LOC", "Registration center location", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTERS_FOR_LOCATION_CODE_EXCEPTION("RES-SER-163", RegistrationConstants.SYSTEM,
			"get registration centers for location code", "get registration centers for location code: Failure",
			"RES-SER", "Residence service", "RS-REG_LOC", "Registration center location", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_REG_CENTERS_PAGINATED("RES-SER-164", RegistrationConstants.SYSTEM, "get registration centers paginated",
			"get registration centers paginated", "RES-SER", "Residence service", "RS-REG", "Registration center",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTERS_PAGINATED_EXCEPTION("RES-SER-166", RegistrationConstants.SYSTEM,
			"get registration centers paginated", "get registration centers paginated: Failure", "RES-SER",
			"Residence service", "RS-REG", "Registration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_CONFIGURATION_PROPERTIES_EXCEPTION("RES-SER-169", RegistrationConstants.SYSTEM,
			"get resident configuration properties failure", "get resident configuration properties: Failure", "RES-SER",
			"Residence service", "RS-CONF", "Config properties", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTER_WORKING_DAYS_EXCEPTION("RES-SER-172", RegistrationConstants.SYSTEM,
			"get registration center working days failure", "get registration center working days: Failure", "RES-SER",
			"Residence service", "RS-REG", "Registration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	UPLOAD_DOCUMENT_SUCCESS("RES-SER-177", RegistrationConstants.SYSTEM, "Document upload: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	UPLOAD_DOCUMENT_FAILED("RES-SER-178", RegistrationConstants.SYSTEM, "Document upload: Failure",
	...
	GET_DOCUMENTS_METADATA_SUCCESS("RES-SER-180", RegistrationConstants.SYSTEM, "Get documents: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENTS_METADATA_FAILED("RES-SER-181", RegistrationConstants.SYSTEM, "Get documents: Failure",
	...
	REQ_AUTH_LOCK_STATUS("RES-SER-182", RegistrationConstants.SYSTEM, "Request auth lock status",
			"Requesting auth lock status for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_LOCK", "Auth lock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_VIDS("RES-SER-191", RegistrationConstants.SYSTEM, "get vids",
			"get vids", "RES-SER", "Residence service", "RS-VID", "VID",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_VIDS_EXCEPTION("RES-SER-193", RegistrationConstants.SYSTEM,
			"get vids failure", "get vids: Failure", "RES-SER",
			"Residence service", "RS-VID", "VID", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_INPUT_ATTRIBUTES_EXCEPTION("RES-SER-199", RegistrationConstants.SYSTEM,
			"get identity attributes failure", "get identity attributes: Failure", "RES-SER",
			"Residence service", "RS-INP_ATTR", "Input attribute", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_TYPE_LOCK("RES-SER-213", RegistrationConstants.SYSTEM, "Request auth type lock",
			"Requesting auth type lock is success", "RES-SER", "Residence service", "RS-AUTH_LOCK", "Auth lock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_IDMAPPING_EXCEPTION("RES-SER-229", RegistrationConstants.SYSTEM,
			"get identity mapping json failure", "get identity mapping json: Failure", "RES-SER",
			"Residence service", "RS-ID_MAP", "ID mapping", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CHECK_AID_STATUS_REQUEST_SUCCESS("RES-SER-234", RegistrationConstants.SYSTEM, "Request credential request status: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	CHECK_AID_STATUS_REQUEST_FAILED("RES-SER-279", RegistrationConstants.SYSTEM, "Request credential request status: Failure",
	...
	GET_DOCUMENT_BY_DOC_ID_SUCCESS("RES-SER-240", RegistrationConstants.SYSTEM, "get document by doc id: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENT_BY_DOC_ID_FAILED("RES-SER-241", RegistrationConstants.SYSTEM, "get document by doc id: Failure",
	...
	DELETE_DOCUMENT_SUCCESS("RES-SER-243", RegistrationConstants.SYSTEM, "delete document: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	DELETE_DOCUMENT_FAILED("RES-SER-244", RegistrationConstants.SYSTEM, "delete document: Failure",
	...
	PIN_STATUS_SUCCESS("RES-SER-252", RegistrationConstants.SYSTEM, "pin status success", "pin status success based on event id: Success", "RES-SER",
			"Resident service", "RS-PIN", "Pin status", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	PIN_STATUS_FAILURE("RES-SER-253", RegistrationConstants.SYSTEM, "pin status", "pin status failure based on event id: Failure", "RES-SER",
			"Resident service", "RS-PIN", "Pin status", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_ACKNOWLEDGEMENT_DOWNLOAD_URL_SUCCESS("RES-SER-258", RegistrationConstants.SYSTEM, "get acknowledgement download url: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_ACKNOWLEDGEMENT_DOWNLOAD_URL_FAILURE("RES-SER-258", RegistrationConstants.SYSTEM, "get acknowledgement download url: Failure",
	...
	GRIEVANCE_TICKET_REQUEST_FAILED("RES-SER-280", RegistrationConstants.SYSTEM,
			"Grievance ticket request: Failure",
			"Grievance ticket request failed", "RES-SER",
			"Resident service", "RS-GRIEV", "Grievance ticket", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENT_TYPES("RES-SER-274", RegistrationConstants.SYSTEM, "get document types",
			"get document types by documentCode and langCode", "RES-SER", "Residence service", "RS-DOC", "Document",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_GENDER_CODE("RES-SER-277", RegistrationConstants.SYSTEM, "get gender code",
			"get gender code by genderName and langCode", "RES-SER", "Residence service", "RS-GEND", "Gender",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CREDENTIAL_STAUTS_UPDATE_CALL_BACK_FAILURE("RES-SER-289", RegistrationConstants.SYSTEM,
			"Credential status update call back: Failure",
