...
public enum EventEnum {
	...
	GET_LOCATION_HIERARCHY_LEVEL_SUCCESS("RES-SER-147", RegistrationConstants.SYSTEM,
			...
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_LOCATION_HIERARCHY_LEVEL_EXCEPTION("RES-SER-148", RegistrationConstants.SYSTEM,
	...
	GET_LOCATION_HIERARCHY_LEVEL_ALL_LANG_EXCEPTION("RES-SER-148", RegistrationConstants.SYSTEM,
			...
			"RES-SER", "Residence service", "RS-LOC", "Location", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_ALL_DYNAMIC_FIELD_VALUE_EXCEPTION("RES-SER-148", RegistrationConstants.SYSTEM,
	...
	GET_APPLICANT_VALID_DOCUMENT_SUCCESS("RES-SER-159", RegistrationConstants.SYSTEM,
			...
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_APPLICANT_VALID_DOCUMENT_EXCEPTION("RES-SER-160", RegistrationConstants.SYSTEM,
	...
	GET_REG_CENTERS_PAGINATED_SUCCESS("RES-SER-165", RegistrationConstants.SYSTEM,
	...
	GET_IDENTITY_UPDATE_COUNT_EXCEPTION("RES-SER-250", RegistrationConstants.SYSTEM,
			...
			"Residence service", "RS-IDEN_COUN", "Identity count", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	PIN_STATUS_SUCCESS("RES-SER-252", RegistrationConstants.SYSTEM, "pin status success",
			"pin status success based on event id: Success", "RES-SER", "Resident service", "RS-PIN", "Pin status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	PIN_STATUS_FAILURE("RES-SER-253", RegistrationConstants.SYSTEM, "pin status",
			"pin status failure based on event id: Failed", "RES-SER", "Resident service", "RS-PIN", "Pin status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),

	UN_PIN_STATUS_SUCCESS("RES-SER-255", RegistrationConstants.SYSTEM, "un pin status: Success",
			"un pin status success based on event id", "RES-SER", "Resident service", "RS-PIN", "Pin status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	UN_PIN_STATUS_FAILURE("RES-SER-256", RegistrationConstants.SYSTEM, "un pin status: Failed",
			"un pin status failure based on event id", "RES-SER", "Resident service", "RS-PIN", "Pin statusE",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),

	GET_ACKNOWLEDGEMENT_DOWNLOAD_URL_SUCCESS("RES-SER-258", RegistrationConstants.SYSTEM,
	...
	INDIVIDUALID_STATUS_SUCCESS("RES-SER-325", RegistrationConstants.SYSTEM, "Checking Individual ID status: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_ACKNOWLEDGEMENT_DOWNLOAD_URL_FAILURE("RES-SER-327", RegistrationConstants.SYSTEM,
			"get acknowledgement download url: Failed", "get acknowledgement download url failed", "RES-SER",
			"Residence service", "RS-ACK_DOWN", "Acknowledgement download",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GRIEVANCE_TICKET_REQUEST_SUCCESS("RES-SER-329", RegistrationConstants.SYSTEM, "Grievance ticket request: Success",
