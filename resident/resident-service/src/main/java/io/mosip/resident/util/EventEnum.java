...
public enum EventEnum {
	...
	RID_STATUS("RES-SER-101", RegistrationConstants.SYSTEM, "Checking RID status", "Request for checking RID status",
			"RES-SER", "Residence service", "RS-RID", "RID Status", RegistrationConstants.RESIDENT_APPLICATION_ID,
	...
	REQ_EUIN("RES-SER-102", RegistrationConstants.SYSTEM, "Request EUIN", "Requesting euin for transaction id %s",
			"RES-SER", "Residence service", "RS-UIN", "EUIN", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_EUIN_SUCCESS("RES-SER-210", RegistrationConstants.SYSTEM, "Request EUIN",
			"Requesting euin for transaction id %s is success", "RES-SER", "Residence service", "RS-UIN", "EUIN",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	REQ_PRINTUIN("RES-SER-103", RegistrationConstants.SYSTEM, "Request to print UIN",
			"Requesting print uin for transaction id %s", "RES-SER", "Residence service", "RS-UIN", "UIN",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_LOCK("RES-SER-104", RegistrationConstants.SYSTEM, "Request auth lock",
			"Requesting auth lock for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_LOCK_UNLOCK", "Auth lock/unlock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_UNLOCK("RES-SER-105", RegistrationConstants.SYSTEM, "Request auth unlock",
			"Requesting auth unlock for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_LOCK_UNLOCK", "Auth lock/unlock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_HISTORY("RES-SER-106", RegistrationConstants.SYSTEM, "Request auth history",
			"Requesting auth history for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_HIST", "Auth history",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	UPDATE_UIN("RES-SER-107", RegistrationConstants.SYSTEM, "Request update uin",
			"Requesting update uin  api for transaction id %s", "RES-SER", "Residence service", "RS-UIN", "Update UIN",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	UPDATE_UIN_SUCCESS("RES-SER-205", RegistrationConstants.SYSTEM, "Request update uin success",
			...
			"Update UIN", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GENERATE_VID("RES-SER-108", RegistrationConstants.SYSTEM, "Request for generating VID",
			"Request for generating VID for transaction id %s", "RES-SER", "Residence service", "RS-GEN_REV_VID", "Generate/Revoke VID",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REVOKE_VID("RES-SER-109", RegistrationConstants.SYSTEM, "Request for revoking VID",
			"Request for revoking VID for transaction id %s", "RES-SER", "Residence service", "RS-GEN_REV_VID", "Generate/Revoke VID",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	VALIDATE_OTP("RES-SER-113", RegistrationConstants.SYSTEM, "%s", "Validate OTP for %s", "RES-SER",
			"Residence service", "RS-OTP", "Otp section", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	IO_EXCEPTION("RES-SER-420", RegistrationConstants.SYSTEM, "%s", "IO exception for transaction id %s", "RES-SER",
			"Residence service", "RS-EXCE", "IO exception", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	JSON_PARSING_EXCEPTION("RES-SER-421", RegistrationConstants.SYSTEM, "Request for UIN update",
			"JSON parsing exception for transaction id %s", "RES-SER", "Residence service", "RS-EXCE", "Json parsing exception",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	BASE_EXCEPTION("RES-SER-401", RegistrationConstants.SYSTEM, "%s", "Base exception for transaction id %s", "RES-SER",
			"Residence service", "RS-EXCE", "Base exception", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQUEST_FAILED("RES-SER-402", RegistrationConstants.SYSTEM, "%s", "Request failed for transaction id %s", "RES-SER",
			"Residence service", "RS-REQ", "Request failed", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	OTP_GEN("RES-SER-121", RegistrationConstants.SYSTEM, "generating otp", "Request for generating otp", "RES-SER",
			"Residence service", "RS-OTP-GEN", "Otp generation", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CREDENTIAL_REQ("RES-SER-124", RegistrationConstants.SYSTEM, "Sharing credential to partner", "Sharing credential to partner", "RES-SER",
			"Residence service", "RS-CRED", "Credential request", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	CREDENTIAL_REQ_SUCCESS("RES-SER-125", RegistrationConstants.SYSTEM, "Sharing credential to partner success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	CREDENTIAL_REQ_EXCEPTION("RES-SER-126", RegistrationConstants.SYSTEM, "Sharing credential to partner failure",
	...
	CREDENTIAL_REQ_STATUS("RES-SER-127", RegistrationConstants.SYSTEM, "credential status",
			"request for credential status", "RES-SER", "Residence service", "RS-CRED_REQ", "Credential request",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CREDENTIAL_CANCEL_REQ("RES-SER-130", RegistrationConstants.SYSTEM, "credential cancel request",
			"credential cancel request", "RES-SER", "Residence service", "RS-CRED_REQ", "Credential request",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CREDENTIAL_TYPES("RES-SER-133", RegistrationConstants.SYSTEM, "credential types", "credential types", "RES-SER",
			"Residence service", "RS-CRED_TYP", "NO_ID_TYPE", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_CARD("RES-SER-136", RegistrationConstants.SYSTEM, "request for card", "request for card", "RES-SER",
			"Residence service", "RS-CARD", "Request card", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_POLICY("RES-SER-139", RegistrationConstants.SYSTEM, "request for policy", "request for policy", "RES-SER",
			"Residence service", "RS-POL", "Request policy", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	VALIDATION_FAILED_EXCEPTION("RES-SER-142", RegistrationConstants.SYSTEM, "Validation failed",
			"Validation failed : %s", "RES-SER", "Residence service", "RS-VAL", "Validation failed",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_VALID_DOCUMENT("RES-SER-143", RegistrationConstants.SYSTEM, "get valid documents",
			"get valid documents by lang code", "RES-SER", "Residence service", "RS-DOC", "Get valid document",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_VALID_DOCUMENT_SUCCESS("RES-SER-144", RegistrationConstants.SYSTEM, "get valid documents",
			"get valid documents by lang code is succeed", "RES-SER", "Residence service", "RS-DOC", "Get valid document",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_VALID_DOCUMENT_EXCEPTION("RES-SER-145", RegistrationConstants.SYSTEM, "get valid documents",
			"get valid documents by lang code is failed", "RES-SER", "Residence service", "RS-DOC", "Get valid document",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_LOCATION_HIERARCHY_LEVEL("RES-SER-146", RegistrationConstants.SYSTEM, "get location hierarchy levels",
			"get location hierarchy level by lang code", "RES-SER", "Residence service", "RS-LOC", "Location hierarchy",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_LOCATION_HIERARCHY_LEVEL_SUCCESS("RES-SER-147", RegistrationConstants.SYSTEM, "get location hierarchy levels",
			...
			"Location hierarchyE", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_LOCATION_HIERARCHY_LEVEL_EXCEPTION("RES-SER-148", RegistrationConstants.SYSTEM, "get location hierarchy levels",
			...
			"Location hierarchy", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_IMMEDIATE_CHILDREN("RES-SER-149", RegistrationConstants.SYSTEM, "get immediate children",
			"get immediate children by location code and lang code", "RES-SER", "Residence service", "RS-CHILD",
	...
	GET_LOCATION_DETAILS("RES-SER-152", RegistrationConstants.SYSTEM, "get location details",
			"get location details by location code and lang code", "RES-SER", "Residence service", "RS-LOC",
			"Location details", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_APPLICANT_VALID_DOCUMENT("RES-SER-158", RegistrationConstants.SYSTEM, "get applicant valid documents",
			"get applicant valid documents", "RES-SER", "Residence service", "RS-DOC", "Document section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_APPLICANT_VALID_DOCUMENT_SUCCESS("RES-SER-159", RegistrationConstants.SYSTEM, "get applicant valid documents",
			"get applicant valid documents is succeed", "RES-SER", "Residence service", "RS-DOC", "Document section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_APPLICANT_VALID_DOCUMENT_EXCEPTION("RES-SER-160", RegistrationConstants.SYSTEM, "get applicant valid documents",
			"get applicant valid documents is failed", "RES-SER", "Residence service", "RS-DOC", "Document section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTERS_FOR_LOCATION_CODE("RES-SER-161", RegistrationConstants.SYSTEM,
			...
			"Residence service", "RS-REG_LOC", "Rgistration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_REG_CENTERS_FOR_LOCATION_CODE_SUCCESS("RES-SER-162", RegistrationConstants.SYSTEM,
			...
			"RES-SER", "Residence service", "RS-REG_LOC", "Rgistration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_REG_CENTERS_FOR_LOCATION_CODE_EXCEPTION("RES-SER-163", RegistrationConstants.SYSTEM,
			...
			"RES-SER", "Residence service", "RS-REG_LOC", "Registration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_REG_CENTERS_PAGINATED("RES-SER-164", RegistrationConstants.SYSTEM, "get registration centers paginated",
			"get registration centers paginated", "RES-SER", "Residence service", "RS-REG", "NO_ID_TYPE",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_CONFIGURATION_PROPERTIES("RES-SER-167", RegistrationConstants.SYSTEM, "get resident configuration properties",
			"get resident configuration properties", "RES-SER", "Residence service", "RS-CONF", "Config properties",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_REG_CENTER_WORKING_DAYS("RES-SER-170", RegistrationConstants.SYSTEM, "get registration center working days",
			"get registration center working days", "RES-SER", "Residence service", "RS-REG", "Registration center",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_LATEST_ID_SCHEMA("RES-SER-173", RegistrationConstants.SYSTEM, "get latest id schema", "get latest id schema",
			"RES-SER", "Residence service", "RS-ID_SCH", "ID schema", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	UPLOAD_DOCUMENT("RES-SER-176", RegistrationConstants.SYSTEM, "Request document upload",
			"Requesting document upload api for transaction id %s", "RES-SER", "Residence service", "RS-DOC",
	...
	UPLOAD_DOCUMENT_SUCCESS("RES-SER-177", RegistrationConstants.SYSTEM, "Document upload success",
			"document upload success for transaction id %s", "RES-SER", "Residence service", "RS-DOC", "Upload doc",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	UPLOAD_DOCUMENT_FAILED("RES-SER-178", RegistrationConstants.SYSTEM, "Document upload failed",
			"document upload failed for transaction id %s", "RES-SER", "Residence service", "RS-DOC", "Upload doc",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_DOCUMENTS_METADATA("RES-SER-179", RegistrationConstants.SYSTEM, "Request get documents",
			"Requesting get documents api for transaction id %s", "RES-SER", "Residence service", "RS-DOC",
			"Doc metadata", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENTS_METADATA_SUCCESS("RES-SER-180", RegistrationConstants.SYSTEM, "Get documents success",
			"get documents success for transaction id %s", "RES-SER", "Residence service", "RS-DOC", "Doc metadata",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENTS_METADATA_FAILED("RES-SER-181", RegistrationConstants.SYSTEM, "Get documents failed",
			"Get documents failed for transaction id %s", "RES-SER", "Residence service", "RS-DOC", "Doc metadata",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),

	REQ_AUTH_LOCK_STATUS("RES-SER-182", RegistrationConstants.SYSTEM, "Request auth lock status",
			"Requesting auth lock status for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_LOCK", "Auth lock status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_AUTH_LOCK_STATUS_SUCCESS("RES-SER-183", RegistrationConstants.SYSTEM, "Request auth lock status success",
			...
			"Auth lock status", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	AUTH_TYPE_CALL_BACK("RES-SER-182", RegistrationConstants.SYSTEM, "Request auth type call back url",
			"Requesting auth type call back url for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_TYP",
			"Auth type", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	UPDATE_AUTH_TYPE_STATUS("RES-SER-185", RegistrationConstants.SYSTEM, "Request update auth type status",
			"Requesting update auth type status for transaction id %s", "RES-SER", "Residence service", "RS-AUTH_TYP",
			"Auth type", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),

	GET_PARTNERS_BY_PARTNER_TYPE("RES-SER-186", RegistrationConstants.SYSTEM, "get partners by partner type",
			"get partners by partner type", "RES-SER", "Residence service", "RS-PARTN", "Partner section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_VIDS("RES-SER-191", RegistrationConstants.SYSTEM, "get vids",
			"get vids", "RES-SER", "Residence service", "RS-VID", "Get VID",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_VIDS_SUCCESS("RES-SER-192", RegistrationConstants.SYSTEM,
			"get vids success", "get vids is succeeded", "RES-SER",
			"Residence service", "RS-VID", "Get VID", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_INPUT_ATTRIBUTES("RES-SER-197", RegistrationConstants.SYSTEM, "get identity attributes",
			"get identity attributes invoked", "RES-SER", "Residence service", "RS-INP_ATTR", "Input attribute",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_TYPE_LOCK("RES-SER-213", RegistrationConstants.SYSTEM, "Request auth type lock",
			"Requesting auth type lock is success", "RES-SER", "Residence service", "RS-AUTH_LOCK", "Auth type lock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_SERVICE_HISTORY("RES-SER-214", RegistrationConstants.SYSTEM, "get service history",
			"get service history", "RES-SER", "Residence service", "RS-SERV_HIS", "Service history",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_SERVICE_REQUEST_UPDATE("RES-SER-215", RegistrationConstants.SYSTEM, "Request service request update",
			"Requesting service request update is success", "RES-SER", "Residence service", "RS-SERV_HIS", "Service history",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_VID_POLICY("RES-SER-224", RegistrationConstants.SYSTEM, "Get VID Policy Request", "Get VID Policy Request",
			"RES-SER", "Residence service", "RS-VID", "VID policy", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_VID_POLICY_SUCCESS("RES-SER-225", RegistrationConstants.SYSTEM, "Get VID Policy Request Success",
			"Get VID Policy Request is success", "RES-SER", "Residence service", "RS-VID", "VID policy",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_VID_POLICY_FAILURE("RES-SER-226", RegistrationConstants.SYSTEM, "Get VID Policy Request Failure",
			"Get VID Policy Request has failed", "RES-SER", "Residence service", "RS-VID", "VID policy",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CHECK_AID_STATUS_REQUEST("RES-SER-233", RegistrationConstants.SYSTEM, "Request Application status",
			"Requesting application status", "RES-SER", "Residence service", "RS-AID", "AID status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CHECK_ORDER_STATUS_EXCEPTION("RES-SER-235", RegistrationConstants.SYSTEM, "check order status",
			"check order status is failed", "RES-SER", "Residence service", "RS-ORD", "Order status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	SEND_PHYSICAL_CARD("RES-SER-236", RegistrationConstants.SYSTEM, "send a physical card",
			"send a physical card", "RES-SER", "Residence service", "RS-PHYS_CARD", "Physical card",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_DOCUMENT_BY_DOC_ID("RES-SER-239", RegistrationConstants.SYSTEM, "get document by doc id",
			"get document by doc id", "RES-SER", "Residence service", "RS-DOC", "Document by docid",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENT_BY_DOC_ID_SUCCESS("RES-SER-240", RegistrationConstants.SYSTEM, "get document by doc id",
			"get document by doc id is succeeded", "RES-SER", "Residence service", "RS-DOC", "Document by docid",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENT_BY_DOC_ID_FAILED("RES-SER-241", RegistrationConstants.SYSTEM, "get document by doc id",
			"get document by doc id is failed", "RES-SER", "Residence service", "RS-DOC", "Document by docid",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	DELETE_DOCUMENT("RES-SER-242", RegistrationConstants.SYSTEM, "delete document",
			"delete document", "RES-SER", "Residence service", "RS-DOC", "NO_ID_TYPE",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	DELETE_DOCUMENT_SUCCESS("RES-SER-243", RegistrationConstants.SYSTEM, "delete document Success",
			"delete document is succeeded", "RES-SER", "Residence service", "RS-DOC", "Delete doc",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	DELETE_DOCUMENT_FAILED("RES-SER-244", RegistrationConstants.SYSTEM, "delete document Failed",
			"delete document is failed", "RES-SER", "Residence service", "RS-DOC", "Delete doc",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	GET_TEMPLATES("RES-SER-245", RegistrationConstants.SYSTEM, "get templates",
			"get templates by langCode and templateTypeCode", "RES-SER", "Residence service", "RS-TEMP", "Templates section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_IDENTITY_UPDATE_COUNT("RES-SER-248", RegistrationConstants.SYSTEM, "get identity update count",
			"retrieve remaining update counts for each id attributes for a UIN/VID", "RES-SER", "Residence service", "RS-IDEN_COUN", "Identity count",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_ACKNOWLEDGEMENT_DOWNLOAD_URL("RES-SER-257", RegistrationConstants.SYSTEM, "get acknowledgement download url",
			"get acknowledgement download url", "RES-SER", "Residence service", "RS-ACK_DOWN", "Acknowledgement download",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	DOWNLOAD_SERVICE_HISTORY("RES-SER-260", RegistrationConstants.SYSTEM, "download service histor",
			"get service history pdf", "RES-SER", "Residence service", "RS-DOWN_SER", "Download service history",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_GENDER_TYPES("RES-SER-261", RegistrationConstants.SYSTEM, "get gender types",
			"get gender types by langCode", "RES-SER", "Residence service", "RS-GEND", "Gender type",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_GENDER_TYPES_SUCCESS("RES-SER-262", RegistrationConstants.SYSTEM, "get gender types success",
			...
			"Gender type", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_GENDER_TYPES_EXCEPTION("RES-SER-263", RegistrationConstants.SYSTEM, "get gender types failure",
			"get gender types by langCode is failed", "RES-SER", "Residence service", "RS-GEND",
			"Gender type", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	INVALID_REQUEST_TYPE_CODE("RES-SER-267", RegistrationConstants.SYSTEM, "Invalid request type code", "\"Invalid Request Type. Please input eventId only for VID_CARD_DOWNLOAD,\" +\n" +
			...
			"Resident service", "RS-VAL", "Invalid Req type", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	DOWNLOAD_SUPPORTING_DOCS("RES-SER-271", RegistrationConstants.SYSTEM, "download supporting docs",
			"ownload supporting docs", "RES-SER", "Residence service", "RS-DOWN_CARD", "Download card",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_DOCUMENT_TYPES("RES-SER-274", RegistrationConstants.SYSTEM, "get document types",
			"get document types by documentCode and langCode", "RES-SER", "Residence service", "RS-DOC", "Document type",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_DOCUMENT_TYPES_SUCCESS("RES-SER-275", RegistrationConstants.SYSTEM, "get document types success",
			...
			"Document type", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_GENDER_CODE("RES-SER-277", RegistrationConstants.SYSTEM, "get gender code",
			"get gender code by genderName and langCode", "RES-SER", "Residence service", "RS-GEND", "Gender code",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_GENDER_CODE_SUCCESS("RES-SER-278", RegistrationConstants.SYSTEM, "get gender code success",
			...
			"Gender code", RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	INVALID_PAGE_START_VALUE("RES-SER-446", RegistrationConstants.SYSTEM, "%s",
			"Invalid page start value %s", "RES-SER", "Residence service", "RS-VAL", "Validating page",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	
	INVALID_PAGE_FETCH_VALUE("RES-SER-447", RegistrationConstants.SYSTEM, "%s",
			"Invalid page fetch value %s", "RES-SER", "Residence service", "RS-VAL", "Validating page",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
