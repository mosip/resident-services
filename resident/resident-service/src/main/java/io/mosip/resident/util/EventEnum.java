...
public enum EventEnum {
	...
	RID_NOT_FOUND("RES-SER-001",RegistrationConstants.SYSTEM,"Checking RID status","RID not found while checking for RID status","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	TOKEN_GENERATION_FAILED("RES-SER-003",RegistrationConstants.SYSTEM,"Generating token","Token generation failed","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	INPUT_INVALID("RES-SER-009",RegistrationConstants.SYSTEM,"%s","Invalid input parameter %s","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	API_NOT_AVAILABLE("RES-SER-005",RegistrationConstants.SYSTEM,"%s","API not available for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	API_RESOURCE_UNACCESS("RES-SER-006",RegistrationConstants.SYSTEM,"%s","Unable to access API resource for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	RID_INVALID("RES-SER-012",RegistrationConstants.SYSTEM,"Check RID","RID is invalid","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	INPUT_DOESNT_EXISTS("RES-SER-002",RegistrationConstants.SYSTEM,"Validating request","Request does not exists","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	TEMPLATE_EXCEPTION("RES-SER-015",RegistrationConstants.SYSTEM,"Get template","Template Exception","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	TEMPLATE_SUBJECT_EXCEPTION("RES-SER-016",RegistrationConstants.SYSTEM,"Get template","Template subject exception","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	NOTIFICATION_FAILED("RES-SER-017",RegistrationConstants.SYSTEM,"%s","Notification failed for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	BAD_REQUEST("RES-SER-020",RegistrationConstants.SYSTEM,"%s","Bad request","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	INVALID_API_RESPONSE("RES-SER-021",RegistrationConstants.SYSTEM,"Checking RID status","Invalid api response while checking RID status","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	IO_EXCEPTION("RES-SER-SYS-002",RegistrationConstants.SYSTEM,"%s","IO exception for transaction id %s","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	JSON_PARSING_EXCEPTION("RES-SER-SYS-003",RegistrationConstants.SYSTEM,"Request for UIN update","JSON parsing exception for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
    OTP_VALIDATION_FAILED("RES-SER-004",RegistrationConstants.SYSTEM,"%s","OTP validation failed for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	...
	REQ_PRINTUIN("RES-SER-103",RegistrationConstants.SYSTEM,"Request for print UIN","Requesting print uin for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	REQ_PRINTUIN_SUCCESS("RES-SER-201",RegistrationConstants.SYSTEM,"Request for print UIN","Requesting print uin api for transaction id %s is success","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	...
	GETTING_RID_STATUS("RES-SER-113",RegistrationConstants.SYSTEM,"Checking RID status","Getting RID status based on individual id","RES-SER","Residence service","NO_ID","NO_ID_TYPE",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	SEND_NOTIFICATION_FAILURE("RES-SER-402",RegistrationConstants.SYSTEM,"%s","Failure notification send for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	...
	OBTAINED_RID_UIN_UPDATE("RES-SER-115",RegistrationConstants.SYSTEM,"Request UIN Update","Obtained RID for transaction id %s while requesting for printing UIN","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	...
	VID_GENERATION_FAILURE("RES-SER-403",RegistrationConstants.SYSTEM,"Request to generate VID","VID generated failed for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
	...
	VID_REVOKE_EXCEPTION("RES-SER-405",RegistrationConstants.SYSTEM,"Request to revoke VID","Revoking VID failed for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME);
