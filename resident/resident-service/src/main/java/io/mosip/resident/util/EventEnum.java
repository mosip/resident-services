...
public enum EventEnum {
	...
	GET_IMMEDIATE_CHILDREN_SUCCESS("RES-SER-151", RegistrationConstants.SYSTEM, "get immediate children: Success",
			"get immediate children by location code and lang code is succeed", "RES-SER", "Residence service",
	...
	GET_REG_CENTERS_PAGINATED_EXCEPTION("RES-SER-162", RegistrationConstants.SYSTEM,
			"get registration centers paginated: Exception", "get registration centers paginated: Failed", "RES-SER",
			"Residence service", "RS-REG", "Registration center", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQ_AUTH_LOCK_STATUS_FAILED("RES-SER-184", RegistrationConstants.SYSTEM, "Request auth lock status: Failed",
			"Requesting auth lock status api is failed", "RES-SER", "Residence service", "RS-AUTH_LOCK", "Auth lock",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	GET_PARTNERS_BY_PARTNER_TYPE_SUCCESS("RES-SER-187", RegistrationConstants.SYSTEM,
			"get partners by partner type: Success", "get partners by partner type is succeeded", "RES-SER",
	...
	REQ_AUTH_LOCK_UNLOCK_SUCCESS("RES-SER-213", RegistrationConstants.SYSTEM, "Request auth lock unlock: Success",
			...
			"Auth lock/unlock", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_SERVICE_REQUEST_UPDATE("RES-SER-215", RegistrationConstants.SYSTEM, "Request service request update",
			"Requesting service request update is success", "RES-SER", "Residence service", "RS-SER_HIS",
			"Service history", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	REQ_SERVICE_REQUEST_UPDATE_SUCCESS("RES-SER-216", RegistrationConstants.SYSTEM,
			"Request service request update: Success", "Requesting service request update is success", "RES-SER",
			"Residence service", "RS-SER_HIS", "Service history", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	CHANNEL_VERIFICATION_STATUS_SUCCESS("RES-SER-222", RegistrationConstants.SYSTEM,
			...
			"Check Channel Verification status Request is success", "RES-SER", "Residence service", "RS-CHAN_VER",
			"Channel verification", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_IDMAPPING_SUCCESS("RES-SER-228", RegistrationConstants.SYSTEM, "get identity mapping json success",
			"get identity mapping json: Success", "RES-SER", "Residence service", "RS-ID_MAP", "ID mapping",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_IDENTITY_UPDATE_COUNT_EXCEPTION("RES-SER-250", RegistrationConstants.SYSTEM,
			...
			"retrieve remaining update counts for each id attributes for a UIN/VID is failed", "RES-SER",
			"Residence service", "RS-IDEN_COUN", "Identity count", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	PIN_STATUS_SUCCESS("RES-SER-251", RegistrationConstants.SYSTEM, "pin status success",
			"pin status success based on event id: Success", "RES-SER", "Resident service", "RS-PIN", "Pin status",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	REQUEST_FAILED("RES-SER-402", RegistrationConstants.SYSTEM, "Request failed",
			"Request failed for transaction id %s", "RES-SER", "Residence service", "RS-REQ", "Request",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	SEND_NOTIFICATION_FAILURE("RES-SER-403", RegistrationConstants.SYSTEM, "Send notification: Failed",
			"Failure notification sent for transaction id %s", "RES-SER", "Residence service", "RS-NOT",
			"Notification section", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	TOKEN_GENERATION_FAILED("RES-SER-409", RegistrationConstants.SYSTEM, "Generating token: Failed",
			"Token generation failed", "RES-SER", "Residence service", "RS-TOK", "Token generation",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	API_NOT_AVAILABLE("RES-SER-411", RegistrationConstants.SYSTEM, "API not available",
			"API not available for transaction id %s", "RES-SER", "Residence service", "RS-API", "API section",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	API_RESOURCE_UNACCESS("RES-SER-412", RegistrationConstants.SYSTEM, "API resource unaccess",
			...
			"API section", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	NOTIFICATION_FAILED("RES-SER-417", RegistrationConstants.SYSTEM, "Notification failed",
			"Notification failed for transaction id %s", "RES-SER", "Residence service", "RS-NOT",
			"Notification section", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	BAD_REQUEST("RES-SER-418", RegistrationConstants.SYSTEM, "Bad request", "Bad request", "RES-SER",
			"Residence service", "RS-REQ", "Bad request", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	IO_EXCEPTION("RES-SER-420", RegistrationConstants.SYSTEM, "IO Exception", "IO exception for transaction id %s",
			"RES-SER", "Residence service", "RS-EXCE", "Exception", RegistrationConstants.RESIDENT_APPLICATION_ID,
			RegistrationConstants.RESIDENT_APPLICATION_NAME),
