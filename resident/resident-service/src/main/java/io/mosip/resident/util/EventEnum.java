...
public enum EventEnum {
	...
	AUTH_TYPE_CALL_BACK("RES-SER-322", RegistrationConstants.SYSTEM, "Request auth type call back url",
	...
	AID_STATUS_SUCCESS("RES-SER-212", RegistrationConstants.SYSTEM, "Checking AID status: Success",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	AID_STATUS_FAILURE("RES-SER-308", RegistrationConstants.SYSTEM, "Checking AID status: Failed",
	...
	RID_DIGITAL_CARD_REQ_FAILURE("RES-SER-232", RegistrationConstants.SYSTEM, "Download digital card request: Failed",
			...
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	RID_DIGITAL_CARD_REQ_EXCEPTION("RES-SER-326", RegistrationConstants.SYSTEM, "Download digital card request: Exception",
			"Download digital card request is failed", "RES-SER", "Residence service", "RS-RID_CARD", "RID digital card",
			RegistrationConstants.RESIDENT_APPLICATION_ID, RegistrationConstants.RESIDENT_APPLICATION_NAME),
	...
	GET_GENDER_TYPES_EXCEPTION("RES-SER-263", RegistrationConstants.SYSTEM, "get gender types: Failed",
	...
	GRIEVANCE_TICKET_REQUEST("RES-SER-328", RegistrationConstants.SYSTEM,
