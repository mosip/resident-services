...
public enum EventEnum {
	...
	SEND_NOTIFICATION_FAILURE("RES-SER-403",RegistrationConstants.SYSTEM,"%s","Failure notification send for transaction id %s","RES-SER","Residence service","%s","Transaction id",RegistrationConstants.APPLICATIONID,RegistrationConstants.APPLICATIONNAME),
