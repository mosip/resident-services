...
public class RequestValidatorTest {
	...
	public void testValidateServiceHistoryRequest() throws Exception{
		...
		String sortType = "";
		String serviceType = "";
		requestValidator.validateServiceHistoryRequest(fromDate, toDate, sortType, sortType, sortType, serviceType);
	}
	...
	public void testValidateServiceHistoryRequestNullSortType() throws Exception{
		...
		LocalDateTime toDate = LocalDateTime.now();
		String serviceType = "DATA_SHARE_REQUEST";
		requestValidator.validateServiceHistoryRequest(fromDate, toDate, null, null, serviceType, null);
	}
	...
	public void testValidateServiceHistoryRequestDateCheck() throws Exception{
		...
		String sortType = "ASC";
		String serviceType = "DATA_SHARE_REQUEST";
		requestValidator.validateServiceHistoryRequest(fromDate, toDate, sortType, serviceType, null, null);
	}
