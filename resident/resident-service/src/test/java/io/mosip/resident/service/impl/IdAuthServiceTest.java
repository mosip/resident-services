...
public class IdAuthServiceTest {
    ...
    public void testGetAuthHistoryDetailsSuccess() throws ApisResourceAccessException {
        ...
        autnTxnDto.setRequestdatetime(DateUtils2.getUTCCurrentDateTime());
    ...
    /**
     * Happy path – OTP verified successfully and transaction updated.
     */
    @Test
    public void validateOtpV2Success() throws Exception {
