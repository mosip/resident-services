...
2. Run the automation test suite JAR file:
   ```
   java -jar -Dmodules=resident -Denv.user=api-internal.<env_name> -Denv.endpoint=<base_env> -Denv.testLevel=smokeAndRegression -jar apitest-resident-1.2.2.0-jar-with-dependencies.jar
   ```
